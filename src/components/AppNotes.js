...
class NotesApp extends React.Component {
  ...
  onDeleteHandler(id) {
    const isConfirmed = window.confirm("Apa kamu yakin untuk menghapus catatan ini?");
    if (isConfirmed) {
  ...
  onArchiveHandler(id) {
    const isConfirmed = window.confirm("Apa kamu yakin untuk mengarsipkan catatan ini?");
    if (isConfirmed) {
